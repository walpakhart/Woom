...
impl Memory {
    ...
    #[tool(
        description = "Full-text search of stored memories. Returns matches with id, content, and tags. SQLite FTS handles multi-word queries — see the search-discipline block in your system context."
    )]
