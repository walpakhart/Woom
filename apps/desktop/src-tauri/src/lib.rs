...
use tauri::State;
// Most github::* types are now used inside ./github_commands.rs;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            github_commands::github_connect_pat,
            github_commands::github_status,
            github_commands::github_disconnect,
            github_commands::github_list_inbox,
            github_commands::github_search_inbox,
            github_commands::github_list_repos,
            github_commands::github_list_repo_items,
            github_commands::github_get_inbox_item,
            github_commands::github_list_workflow_runs,
            github_commands::github_rerun_workflow,
            github_commands::github_cancel_workflow,
            github_commands::github_list_tree,
            github_commands::github_get_file_content,
            github_commands::github_list_releases,
            github_commands::github_list_repo_commits,
            github_commands::github_list_repo_branches,
            github_commands::github_get_readme,
            github_commands::github_get_pr,
            github_commands::github_list_pr_files,
            github_commands::github_list_pr_commits,
            github_commands::github_list_check_runs,
            github_commands::github_list_pr_reviews,
            github_commands::github_list_review_comments,
            github_commands::github_list_comments,
            github_commands::github_get_commit,
            github_commands::github_add_comment,
            github_commands::github_submit_review,
            github_commands::github_set_state,
            github_commands::github_merge_pr,
            github_commands::github_edit_pr,
            github_commands::github_request_reviewers,
            github_commands::github_remove_reviewers,
            github_commands::github_add_labels,
            github_commands::github_remove_labels,
            github_commands::github_add_assignees,
            github_commands::github_remove_assignees,
            ...
            ledger::ledger_set_final_check,
            ledger::ledger_recheck,
...
// GitHub Tauri commands moved to ./github_commands.rs
// (wave-27 split). `token()` stays in lib.rs because non-github
