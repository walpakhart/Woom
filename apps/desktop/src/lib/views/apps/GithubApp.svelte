...
<section
  class="app-shell"
  style="--app-tone: var(--src-github); --app-glow: rgba(181,132,255,0.40); grid-template-columns: 380px 1fr;"
>
  <GithubList
...
<style>
  ...
  /* GithubFocusOverlay содержит .slide-over wrap — глобальный override
     в app.css снимает с него modal-positioning внутри .app-shell. */
</style>
